...
config :countdown, CountdownWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "CCW5QhdXNPn+h+WpDJDJTU0RuB8vDeK0m22KP5oJ6pvBgfQIh4jrHsuMyD4kAtsV",
...
#  we're using Auth0 as part of this tutorial. I've never used it before
#  and have doubts about it since I'm used to building my own logins
